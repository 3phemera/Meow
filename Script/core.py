...
conv_block4 = tf.keras.layers.MaxPool2D(strides=2,pool_size=(3,3),padding='same')(conv_block3)
...
conv_block8 = tf.keras.layers.Conv2D(64, (3,3), strides=1, padding='same')(conv_block7)
...
conv_block14 = tf.keras.layers.Conv2D(64, (3,3), strides=1, padding='same')(conv_block13)
...
conv_block20 = tf.keras.layers.Conv2D(128, (3,3), strides=1, padding='same')(conv_block19)
...
conv_block27 = tf.keras.layers.Conv2D(128, (3,3), strides=1, padding='same')(conv_block26)
...
conv_block33 = tf.keras.layers.Conv2D(256, (3,3), strides=1, padding='same')(conv_block32)
...
conv_block40 = tf.keras.layers.Conv2D(256, (3,3), strides=1, padding='same')(conv_block39)
...
conv_block46 = tf.keras.layers.Conv2D(512, (3,3), strides=1, padding='same')(conv_block45)
...
conv_block53 = tf.keras.layers.Conv2D(512, (3,3), strides=1, padding='same')(conv_block52)
...
model.fit(train_ds, validation_data=val_ds, batch_size=32,epochs=100)